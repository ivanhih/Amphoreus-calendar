...
public final class CalendarApp extends Application {
    ...
    @Override public void onCreate() {
        ...
        IO.execute(()->{ Reminders.reschedule(this); Widgets.updateAll(this); CalendarRefreshJob.schedule(this); });
    }
    ...
    public void changed() { refreshCalendarObserver(); IO.execute(()->{ Reminders.reschedule(this); Widgets.updateAll(this); CalendarRefreshJob.schedule(this); }); }
}
