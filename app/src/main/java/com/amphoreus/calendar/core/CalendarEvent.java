...
public final class CalendarEvent {
    ...
    /** ICS subscriptions default to a three-day advance reminder; users can change it per event. */
    public static final int DEFAULT_IMPORTED_REMINDER_MINUTES=3*24*60;
    public long id;
    ...
    /** Read-only event imported from a user-configured ICS subscription. */
    ...
    public String key() { return imported ? "i:" + id : (system ? "s:" : "l:") + id; }
    public CalendarEvent copy() {
        ...
        e.recurrence=recurrence; e.imported=imported; e.importUid=importUid; e.reminderMinutes=reminderMinutes; e.appReminderMinutes=appReminderMinutes; e.reminderArt=reminderArt; e.color=color;
