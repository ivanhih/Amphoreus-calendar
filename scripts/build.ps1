...
Run-Checked "$buildTools\aapt2.exe" @('link','-o',"$output\base.apk",'-I',$androidJar,'--manifest',"$output\AndroidManifest.xml",'--java',"$output\generated",'--min-sdk-version','26','--target-sdk-version','35','--version-code','1','--version-name','0.1.0',"$output\resources.zip")
...
if ($DeviceTests) { & "$PSScriptRoot\device-tests.ps1" -Sdk $Sdk -Jdk $Jdk }
